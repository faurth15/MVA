...
Original file is located at
    https://colab.research.google.com/drive/1FmhFmLJF126H2LLpFm06moCpDu4zVFMm
...
!aria2c -x 10 -j 10 https://github.com/jbrownlee/Datasets/releases/download/Flickr8k/Flickr8k_Dataset.zip
!aria2c -x 10 -j 10 https://github.com/jbrownlee/Datasets/releases/download/Flickr8k/Flickr8k_text.zip

!unzip /content/Flickr8k_Dataset.zip
!unzip /content/Flickr8k_text.zip

!aria2c -x 10 -j 10 http://cs.stanford.edu/people/karpathy/deepimagesent/caption_datasets.zip

!unzip /content/caption_datasets.zip
...
word_map_file = '/content/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with and the model was trained with
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")  # sets device for model and PyTorch tensors
cudnn.benchmark = True  # set to true only if inputs to model are fixed size; otherwise lot of computational overhead
